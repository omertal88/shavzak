...
class Ui_AssignmentDialog(object):
    def setupUi(self, AssignmentDialog):
        ...
        self.pushButton = QtWidgets.QPushButton(AssignmentDialog)
        self.pushButton.setObjectName("pushButton")
        self.verticalLayout.addWidget(self.pushButton)
        self.pushButton_2 = QtWidgets.QPushButton(AssignmentDialog)
        ...
        self.pushButton.clicked.connect(AssignmentDialog.addAssignee)
        self.pushButton_2.clicked.connect(AssignmentDialog.removeAssignee)
    ...
    def retranslateUi(self, AssignmentDialog):
        ...
        self.pushButton.setText(_translate("AssignmentDialog", "שבץ חייל"))
        self.pushButton_2.setText(_translate("AssignmentDialog", "הסר חייל"))
