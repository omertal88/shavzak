...
class Ui_Shavzak(object):
    def setupUi(self, Shavzak):
        ...
        self.verticalLayout_2.addWidget(self.shiftsView)
        ...
        self.exportToCsvAction = QtWidgets.QAction(Shavzak)
        self.exportToCsvAction.setObjectName("exportToCsvAction")
        ...
        self.menuFile.addAction(self.exportToCsvAction)
        ...
        self.exportToCsvAction.triggered.connect(Shavzak.exportToCsv)
        self.pushButton_2.clicked.connect(Shavzak.exportToXlsx)
    ...
    def retranslateUi(self, Shavzak):
        ...
        self.pushButton_2.setText(_translate("Shavzak", "ייצא לאקסל"))
