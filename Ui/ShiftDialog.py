...
class Ui_ShiftDialog(object):
    def setupUi(self, ShiftDialog):
        ...
        self.splitShiftSpin.setEnabled(False)
        ...
        self.splitShiftCheck.toggled['bool'].connect(self.splitShiftSpin.setEnabled)
        self.splitShiftCheck.toggled['bool'].connect(self.nicknameEdit.setDisabled)
