...
class Ui_ShiftDialog(object):
    def setupUi(self, ShiftDialog):
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.stickToShiftCombo)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.validUntilCheck)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.validUntilDatetime)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.validFromDatetime)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.splitShiftCheck)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.splitShiftSpin)
        ...
        ShiftDialog.setTabOrder(self.splitShiftSpin, self.uidEdit)
