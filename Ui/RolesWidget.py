...
class Ui_RolesWidget(object):
    def setupUi(self, RolesWidget):
        ...
        self.gridLayout.addWidget(self.grenadeLauncherCheck, 1, 0, 1, 1)
        self.hamalistCheck = QtWidgets.QCheckBox(RolesWidget)
        self.hamalistCheck.setObjectName("hamalistCheck")
        self.gridLayout.addWidget(self.hamalistCheck, 2, 0, 1, 1)
        ...
        RolesWidget.setTabOrder(self.squadCommanderCheck, self.sharpshooterCheck)
