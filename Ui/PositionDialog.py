...
class Ui_NewPositionDialog(object):
    def setupUi(self, NewPositionDialog):
        ...
        NewPositionDialog.setTabOrder(self.manpowerSpin, self.rolesWidget)
        NewPositionDialog.setTabOrder(self.rolesWidget, self.organicPlatoonsCheck)
        ...
        NewPositionDialog.setTabOrder(self.uidEdit, self.notCommanderCheck)
        NewPositionDialog.setTabOrder(self.notCommanderCheck, self.spacingNeededCheck)
