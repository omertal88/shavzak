...
class Ui_ShiftDialog(object):
    def setupUi(self, ShiftDialog):
        ...
        self.startHourEdit = QtWidgets.QLineEdit(ShiftDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.startHourEdit.sizePolicy().hasHeightForWidth())
        self.startHourEdit.setSizePolicy(sizePolicy)
        self.startHourEdit.setMaximumSize(QtCore.QSize(50, 16777215))
        self.startHourEdit.setObjectName("startHourEdit")
        self.horizontalLayout.addWidget(self.startHourEdit)
        self.label_6 = QtWidgets.QLabel(ShiftDialog)
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout.addWidget(self.label_6)
        self.startMinuteEdit = QtWidgets.QLineEdit(ShiftDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.startMinuteEdit.sizePolicy().hasHeightForWidth())
        self.startMinuteEdit.setSizePolicy(sizePolicy)
        self.startMinuteEdit.setMaximumSize(QtCore.QSize(50, 16777215))
        self.startMinuteEdit.setObjectName("startMinuteEdit")
        self.horizontalLayout.addWidget(self.startMinuteEdit)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.stickToShiftCombo)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.validFromDatetime)
        self.validUntilDatetime = QtWidgets.QDateTimeEdit(ShiftDialog)
        self.validUntilDatetime.setObjectName("validUntilDatetime")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.validUntilDatetime)
